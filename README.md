...
```mermaid
flowchart TD
    A[Start: Curious Student] --> B[3rd Sem: Basics of Programming]
    B --> C[4th Sem: Data Structures & ML Intro]
    C --> D[5th Sem: Machine Learning Projects]
    D --> E[6th Sem: Deep Learning & Applications]
    E --> F[7th Sem: Advanced AI & Systems]
    F --> G[8th Sem: Real-World Case Studies]
    G --> H[Future: '...' Labs Founder]

    style A fill:#ff9a9e,stroke:#333,stroke-width:2px
    style H fill:#a18cd1,stroke:#333,stroke-width:2px
```
